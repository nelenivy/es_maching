...
'exp_name=data_fusion_early_fusion_mod_embs_concat_100_post_norm_no_amt_dyn_pos_3_segmdiff_segm' \
'~seq_encoder=early_fusion_time' "+seq_encoder=early_fusion_time_dyn_segm"
