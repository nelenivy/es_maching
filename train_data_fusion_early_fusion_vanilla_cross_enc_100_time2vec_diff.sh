...
'exp_name=data_fusion_early_fusion_vanilla_cross_enc_100_post_norm_no_amt_time2vec_no_rel_diff' \
'~seq_encoder=early_fusion_time' "+seq_encoder=early_fusion_time_time2vec_diff"
