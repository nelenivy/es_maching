...
'exp_name=data_fusion_early_fusion_vanilla_cross_enc_100_post_norm_no_amt_time_full' \
'~trx=data_fusion' '+trx=data_fusion_time_full' '~ifilters=data_fusion' '+ifilters=data_fusion_time' 
