...
"~data=MBD_early" "+data=MBD_early_100" 'exp_name=MBD_early_fusion_blending_100_no_sample_no_amt_concat_dyn_3' \
"~trx=MBD_no_time" "+trx=MBD_no_time_no_amt" '~seq_encoder=early_fusion' "+seq_encoder=early_fusion_dyn"